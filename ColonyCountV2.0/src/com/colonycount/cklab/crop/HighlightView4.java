...
public class HighlightView4 {
    ...
    public HighlightView4(View ctx) {
        mContext = ctx;
    }
    ...
    protected void draw(Canvas canvas) {
        ...
        float mWidth  = mDrawRect.width();
        float mHeight = mDrawRect.height();
      
        path.addCircle(mDrawRect.left + (mWidth  / 2),
                       mDrawRect.top + (mHeight / 2),
                       mWidth / 2,
                       Path.Direction.CW);
