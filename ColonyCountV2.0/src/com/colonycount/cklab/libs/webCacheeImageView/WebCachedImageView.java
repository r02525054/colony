package com.colonycount.cklab.libs.webCacheeImageView;
...
public class WebCachedImageView extends ImageView {
	...
	public void setBitmapDecodedListener(BitmapDecodedListener bitmapDecodedListener){
...
//			mAppearAnimation.setDuration(300);
			mAppearAnimation.setDuration(0);
	...
	public void setImageUrl(String url) {
		...
		if (url != null && cancelPotentialWork(url)) {
			final BitmapWorkerTask bitmapWorkerTask = new BitmapWorkerTask(this, bitmapDecodedListener);
