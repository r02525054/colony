...
public class SaveAndUploadImageAsyncTask extends BaseAsyncTask {
	...
	public SaveAndUploadImageAsyncTask(Context context, String progressDialogTitle, String progressDialogMsg, AsyncTaskCompleteListener<Boolean> listener, Class<?> cls, byte[] data_raw, byte[] data_counted, String user_account, String user_id, ImgInfo imgInfo) {
...
//				}
	...
	public void addRequest(List<NameValuePair> reqParams){
		...
		reqParams.add(new BasicNameValuePair("tag_date", imgInfo.getDate()));
