...
package com.colonycount.cklab.rangebar;
...
public class CustomSeekBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = 0x1ab1e5;
...
//        mRightThumb.draw(canvas);
     ...
     *            existing listener
     */
    public void setOnRangeBarChangeListener(CustomSeekBar.OnSeekBarChangeListener listener) {
        mListener = listener;
    }
