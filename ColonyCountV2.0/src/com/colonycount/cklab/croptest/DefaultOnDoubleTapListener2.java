 ...
 */
public class DefaultOnDoubleTapListener2 implements GestureDetector.OnDoubleTapListener {
     ...
     */
    public DefaultOnDoubleTapListener2(PhotoViewAttacher2 photoViewAttacher) {
        ...
        if (null != photoViewAttacher.getOnPhotoTapListener()) {
            ...
            if (null != displayRect) {
                ...
                if (displayRect.contains(x, y)) {
                    ...
                    float xPerc = (x - displayRect.left)
                            / displayRect.width();
                    float yPerc = (y - displayRect.top)
                            / displayRect.height();
                    
                    photoViewAttacher.getOnPhotoTapListener().onPhotoTap(imageView, xPerc, yPerc, x, y);
